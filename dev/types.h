...
enum TypeOfAction {
    ...
    ADD_REMOTE_ACCOUNT,  ///< Добавить аккаунт социальной сети из привязанных к локальному аккаунту
    DELETE_REMOTE_ACCOUNT,  ///< Удалить аккаунт социальной сети из привязанных к локальному аккаунту
